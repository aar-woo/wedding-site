...
- [x] **Phase 7: Datastore Schema & Link-Generation Tooling** - Neon Postgres provisioned, guest schema migrated, local script mints real shareable links (completed 2026-05-31)
...
- [x] 07-02-PLAN.md — Pure DB-free link helpers + node:test unit suite (BACK-01, LINK-04)
- [x] 07-03-PLAN.md — generate-links.js + check-link.js + live Neon run (BACK-01, LINK-04)
...
- [x] 08-02-PLAN.md — api/guest/[id].js Neon lookup + vercel.json + endpoint harness + VITE_ audit (BACK-02, BACK-03)
**UI hint**: yes
...
| 7. Datastore Schema & Link-Generation | 3/3 | Complete   | 2026-05-31 |
